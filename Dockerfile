...
# LIBVIPS
RUN curl -OL https://github.com/jcupitt/libvips/releases/download/v8.5.6/vips-8.5.6.tar.gz
RUN tar zvxf vips-8.5.6.tar.gz && cd vips-8.5.6 && ./configure && make && make install
RUN rm -rf vips*
